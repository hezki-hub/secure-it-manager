                                ...
                                switch (adminChoice) {
                                    ...
                                    case 2:
                                        ...
                                        if (deviceChoice == 1) {
                                            ...
                                            deviceService.addDevice(devCustId, type, brand, serial, status);
                                            ...
                                            int statusOpt = getValidIntInput(input,
                                                    "Select Status: 1) ACTIVE  2) UNDER_MAINTENANCE  3) DECOMMISSIONED:");

                                            DeviceStatus newStatus = DeviceStatus.ACTIVE;
                                            if (statusOpt == 2)
                                                newStatus = DeviceStatus.UNDER_MAINTENANCE;
                                            if (statusOpt == 3)
                                    ...
                                    case 3:
                                        ...
                                        if (ticketChoice == 1) {
                                            ...
                                            int tStatusOpt = getValidIntInput(input,
                                                    "Select Status: 1) OPEN  2) IN_PROGRESS  3) RESOLVED  4) CLOSED");

                                            TicketStatus newTStatus = TicketStatus.OPEN;
                                            if (tStatusOpt == 2)
                                                newTStatus = TicketStatus.IN_PROGRESS;
                                            if (tStatusOpt == 3)
                                                newTStatus = TicketStatus.RESOLVED;
                                            if (tStatusOpt == 4)
                                                newTStatus = TicketStatus.CLOSED;
